# Getting Started with Climate Device Proxy

This guide will help you install and set up the Climate Device Proxy custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/Rjvs/climate-proxy`
6. Set category to "Integration"
7. Click "Add"
8. Find "Climate Device Proxy" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/Rjvs/climate-proxy/releases)
2. Extract the `climate_proxy` folder from the archive
3. Copy it to `custom_components/climate_proxy/` in your Home Assistant configuration directory
...
4. Select entities from "Climate Device Proxy"

Example entities card:

```yaml
type: entities
title: Climate Device Proxy
entities:
...
- Report issues at [GitHub Issues](https://github.com/Rjvs/climate-proxy/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/Rjvs/climate-proxy/discussions)
