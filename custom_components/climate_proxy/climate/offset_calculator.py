...
def calculate_device_setpoint(
    ...
    Returns:
        Setpoint to send to the physical device.
    """
    offset = device_internal_temp - external_temp
    return proxy_target + offset
...
def calculate_setpoint_range(
    ...
    Returns:
        (device_setpoint_low, device_setpoint_high) to send to physical device.
    """
    offset = device_internal_temp - external_temp
    return proxy_target_low + offset, proxy_target_high + offset
