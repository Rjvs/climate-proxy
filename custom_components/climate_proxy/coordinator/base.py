"""
Core DataUpdateCoordinator implementation for climate_proxy.
...
from custom_components.climate_proxy.api import ClimateProxyApiClientAuthenticationError, ClimateProxyApiClientError
...
class ClimateProxyDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except ClimateProxyApiClientAuthenticationError as exception:
