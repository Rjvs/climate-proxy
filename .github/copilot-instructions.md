...
- `entity/` - Base entity class (`ClimateProxyEntity`)
...
- All entities inherit: `(PlatformEntity, ClimateProxyEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.climate_proxy: debug` in `config/configuration.yaml`
