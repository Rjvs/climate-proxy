...
**File:** `custom_components/climate_proxy/services.yaml`
...
Create `custom_components/climate_proxy/service_actions/[action_name].py`:

```python
"""[Action name] service action for Climate Device Proxy."""
...
**File:** `custom_components/climate_proxy/const.py`
...
3. Find service action: `climate_proxy.[action_name]`
...
- **Service actions directory:** `custom_components/climate_proxy/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/climate_proxy/services.yaml` (legacy filename)
- **Icons:** `custom_components/climate_proxy/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/climate_proxy/translations/*.json` under `services` key (legacy)
