...
**Directory:** `custom_components/climate_proxy/[platform]/`
...
```python
"""[Platform] platform for Climate Device Proxy."""
...
from .entity import ClimateProxyEntity
from .[entity_file] import ClimateProxy[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: ClimateProxyDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            ClimateProxy[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Climate Device Proxy."""
...
Add platform to `custom_components/climate_proxy/manifest.json`:
...
- [ ] Entity class inherits from both `ClimateProxyEntity` and platform class
...
- **Class prefix:** `ClimateProxy`
- **Base entity:** `ClimateProxyEntity` in `entity/base.py`
- **Coordinator:** `ClimateProxyDataUpdateCoordinator`
