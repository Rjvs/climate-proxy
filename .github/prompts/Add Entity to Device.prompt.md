...
- Inherit from `ClimateProxyEntity` and platform base class
...
- Entity: `custom_components/climate_proxy/[platform]/[entity_name].py`
- Platform: `custom_components/climate_proxy/[platform]/__init__.py`
