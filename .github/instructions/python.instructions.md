...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `ClimateProxy`
...
- Inherit from both platform entity and `ClimateProxyEntity` (order matters)
...
from custom_components.climate_proxy.sensor import async_setup_entry
...
**Config entry data:** `entry_data: ClimateProxyData = hass.data[DOMAIN][entry.entry_id]`
