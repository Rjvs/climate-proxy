...
- `ClimateProxyApiClientError` (Base)
- `ClimateProxyApiClientCommunicationError` (Network, timeout, HTTP errors)
- `ClimateProxyApiClientAuthenticationError` (401, 403, invalid credentials)
